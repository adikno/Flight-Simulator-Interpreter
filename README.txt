...
In order to activate the program, two arguments should be implemented in the flightGear's setting:
...
In addition, the included "generic_small.xml" file should be putted inside the FlightGear installation folder "data/Protocol".
